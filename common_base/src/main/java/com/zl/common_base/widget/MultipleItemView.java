...
public class MultipleItemView extends LinearLayout {
    ...
    private void init(Context context,AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MultipleItemView);
        ...
        showEditText = a.getBoolean(R.styleable.MultipleItemView_showEditText, showEditText);
        a.recycle();
